...
<?php require_once "dashboard/aside.php"?>
...
<div class="card mb-4">
<h5 class="card-header">تعديل كاتب </h5>
<form class="card-body" action="/update_author" method="POST" enctype="multipart/form-data">
<input type="hidden" name="authorid" value="<?= $param['id'] ?>">
<div class="row g-3">
<div class="col-md-6">
<label class="form-label" for="multicol-username">اسم الكاتب</label>
<input name="author_name" type="text" value="<?= $param['name'] ?>" id="multicol-username" class="form-control" placeholder="john.doe" />
</div>
<div class="col-md-6">
<label class="form-label" for="multicol-email">رقم الهاتف</label>
<div class="input-group input-group-merge">
  <input  name="phone" type="text" value="<?= $param['phone'] ?>"  class="form-control"  aria-describedby="multicol-email2" />
...
<div class="input-group input-group-merge">
  <input  name="email" type="email" value="<?= $param['email'] ?>"  class="form-control"  aria-describedby="multicol-email2" />
...
<div class="input-group input-group-merge">
  <input  name="bio" type="text" value="<?= $param['bio'] ?>"  class="form-control"  aria-describedby="multicol-email2" />
